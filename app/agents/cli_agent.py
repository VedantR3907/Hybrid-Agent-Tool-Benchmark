...
class CliAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "You have full freedom to run any PowerShell command — there are no restrictions on what commands you can use. "
            ...
            "PDF files are in the pdfs/ directory. "
            "SQLite databases are in the sqlite/ directory. The sqlite3 CLI binary may not be installed; use Python's sqlite3 module via 'python -c \"import sqlite3; ...\"' to run queries. "
            "Do not read raw bytes from binary or image files. "
